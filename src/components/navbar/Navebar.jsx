  ...
  return (
    <>
      <Navbar
        ...
        className="border-0 drop-shadow-md ...  w-full   flex  items-center text-black    sticky top-0 z-20"
      >
        <div className="container mx-auto flex items-center justify-between  ">
          <NavLink to="/">
          <div className="flex  flex-row   gap-2  ">
            <p className="text-[1.5em] font-serif font-bold">
              Hiring Era
            </p>
          </div>
          </NavLink>
          ...
          <div className="hidden items-center gap-5 lg:flex">
            ...
            {/* <NavLink to="/about">
              <div className=" hover-underline  flex justify-center items-center  ">
                <p>About</p>
              </div>
            </NavLink>
            <NavLink to="/contact">
